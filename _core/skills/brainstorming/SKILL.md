...
1. **Explore context** — Read files, docs, recent commits to understand the current state
...
5. **Write design doc** — Save to `docs/specs/`. Run a self-review for placeholders, contradictions, scope issues
